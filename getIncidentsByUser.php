...
$mysql_query = "SELECT ut.surname, ut.name, inc.id_incident,  inc.title, inc.content, inc.location, inc.date, t.value as tag, imp.value as importance, urg.value as urgence from incident as inc,
